...
public interface ITheOneProbe {
     ...
     * @param provider
     */
    void registerProvider(@Nonnull IProbeInfoProvider provider);
     ...
     * @param provider
     */
    void registerEntityProvider(@Nonnull IProbeInfoEntityProvider provider);
     ...
     */
    int registerElementFactory(@Nonnull IElementFactory factory);
     ...
     * this server side.
     */
    void registerProbeConfigProvider(@Nonnull IProbeConfigProvider provider);
     ...
     */
    void registerBlockDisplayOverride(@Nonnull IBlockDisplayOverride override);
     ...
     */
    void registerEntityDisplayOverride(@Nonnull IEntityDisplayOverride override);
}
